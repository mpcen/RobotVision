...
char **argv;
{
        ...
        fp1=fopen("G:/Hybrid_Files/Dropbox/Documents/Classes/Classes Spring 2012-2013/Robotics Vision/Assignment/Assignment1/First_Part/chess1.pgm","rb");
        readHeader(fp1);
